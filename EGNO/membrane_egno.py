#Run - python membrane_egno.py --config_by_file
...
def train(model, optimizer, epoch, loader, backprop=True):
    ...
    for batch_idx, data in enumerate(loader):
        ...
        # Shape of loc: torch.Size([3, 1757, 3])
        # Shape of vel: torch.Size([3, 1757, 3])
        # Shape of edges: [torch.Size([2, 30038]), torch.Size([2, 30038]), torch.Size([2, 30038])]
        # Shape of edge_attr: [torch.Size([30038, 1]), torch.Size([30038, 1]), torch.Size([30038, 1])]
        # Shape of local_edges: [torch.Size([2, 10222]), torch.Size([2, 10222]), torch.Size([2, 10222])]
        # Shape of local_edge_fea: [torch.Size([10222, 1]), torch.Size([10222, 1]), torch.Size([10222, 1])]
        # Shape of Z: torch.Size([3, 1757, 1])
        # Shape of loc_end: torch.Size([21084, 3])
        # Shape of vel_end: torch.Size([21084, 3])
        ...
        if args.model == 'egno':
            ...
            nodes = torch.cat((nodes, Z / Z.max()), dim=-1) #velocity magnitude and Z coords
            rows, cols = edges
