...
def main(checkpoint_path=None):
    ...
    # Load data
    train_loader, val_loader, scaler = dataloader('../1e6', radius_train, batch_size)
    print("----Loaded Data----")
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if (epoch + 1) % validation_frequency == 0:
            ...
            predictions_original_scale = all_predictions #scaler.inverse_transform(all_predictions.reshape(-1, 1))
            true_values_original_scale = all_true_values #scaler.inverse_transform(all_true_values.reshape(-1, 1))
